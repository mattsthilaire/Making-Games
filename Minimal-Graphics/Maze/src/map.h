...
public:
    ...
    Map(int map_width, int map_height, int pixel_width, int pixel_height, float fill_percent) : gen(std::random_device{}()), map_width(map_width), map_height(map_height), fill_percent(fill_percent)
    {
